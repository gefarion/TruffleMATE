...
public final class DirectCallNodeWrapper extends DirectCallNode implements WrapperNode {
  @Child private DirectCallNode delegate;
  @Child private ProbeNode      probe;

  public DirectCallNodeWrapper(final DirectCallNode delegate, final ProbeNode probe) {
    super(null);
